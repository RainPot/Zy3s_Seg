...
class PAmodule(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4, x0):  #x1:256  x2:512  x3:1024  x4:2048  x0:128
        ...
        return out_feat, x4_guidence_out, x4x2_gate, x4x2_gate_reverse, x4x1_gate, x4x1_gate_reverse,  x4x0_gate, x4x0_gate_reverse
...
class DIGModule(nn.Module):
    ...
    def forward(self, feat, stagecur, stage0):
        ...
        return feat_stagecur_cat, stagecur_spatial, similarity_map, stage0
...
class PANet(nn.Module):
    ...
    def forward(self, x):
        ...
        feat, x4_guidence, x4x2_gate, x4x2_gate_reverse, x4x1_gate, x4x1_gate_reverse,  x4x0_gate, x4x0_gate_reverse= self.PAModule(x1, x2, x3, x4, x0)
        feat1, stagecur_spatial1, similarity_map1, stage01 = self.DIGModule1(feat, x3, x0)
        feat2, stagecur_spatial2, similarity_map2, stage02 = self.DIGModule2(feat1, x2, x0)
        feat3, stagecur_spatial3, similarity_map3, stage03 = self.DIGModule3(feat2, x1, x0)
        ...
        return final, x4_guidence, similarity_map3, x4x2_gate, x4x1_gate, x4x0_gate
