...
class DIGModule(nn.Module):
    def __init__(self, stagecur_stage0 = 0, featstagecur = 0, stage_channel = 128):
        ...
        self.stage0_conv = nn.Conv2d(128, 1, kernel_size=1, stride=1, padding=0)
        self.maxpool = nn.MaxPool2d(2, 2)
        self.sigmoid = nn.Sigmoid()

        self.stage_conv = ConvBNReLU(stage_channel, 128, kernel_size=1, stride=1, padding=0)
        self.stage_spatial_conv = nn.Conv2d(128, 1, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, feat, stagecur, stage0):
        ...
        feat = feat + feat * stagecur_spatial
        ...
        feat_stagecur_cat = feat_stagecur_cat + feat_stagecur_cat * similarity_map
        ...
        feat_stagecur_cat = feat_stagecur_cat + feat_stagecur_cat * stage0
