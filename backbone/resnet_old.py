...
def resnet34(pretrained=False):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [3, 4, 6, 3], dilated=True, norm_layer=nn.BatchNorm2d,
...
def resnet50(pretrained=False):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3], dilated=True, norm_layer=nn.BatchNorm2d,
                   multi_grid=False, multi_dilation=None)
    if pretrained:
...
def resnet101(pretrained=False):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 23, 3], dilated=True, norm_layer=nn.BatchNorm2d,
                   multi_grid=False, multi_dilation=None)
...
def resnet152(pretrained=False):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 8, 36, 3], dilated=True, norm_layer=nn.BatchNorm2d,
                   multi_grid=False, multi_dilation=None)
    if pretrained:
